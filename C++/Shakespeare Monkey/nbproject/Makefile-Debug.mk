...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shakespeare_monkey

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shakespeare_monkey: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shakespeare_monkey ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/Population.o: src/Population.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iincludes -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Population.o src/Population.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shakespeare_monkey
